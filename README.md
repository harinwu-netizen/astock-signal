...
| **v6.15** | 2026-06-15 | 止损决策统一重构 + max_hold_days bug 修复 |
| **v6.14** | 2026-06-14 | TradeResult.pnl 老 bug 修复（v6.13 静默引入）|
| **v6.13** | 2026-06-14 | 信号可观测性 + 资金流降级 + 独立止损 + 时间窗口保护 |
| **v6.12** | 2026-06-10 | 资金流 15 分钟缓存 + push2delay 健康探测 |
| **v6.9** | 2026-06-04 | push2delay 集成资金流 fallback（不限流公开端点）|
| **v6.6** | 2026-06-04 | outbox 守护进程（取代"小海 heartbeat"不可靠机制）|

完整历史：[`CHANGELOG.md`](CHANGELOG.md)（v6.0 ~ v6.20，共 23 个版本）
